...
class Grants(models.Model):
    ...
    hhs_payment_ind = models.CharField(max_length=1) # What is ind?
    ...
    extramural_ind = models.CharField(max_length=1, blank=True, null=True) # Is _ind an index, indicating an FK?
    proj_cfda_no = models.CharField(max_length=40, blank=True, null=True)
    proj_science_cd = models.CharField(max_length=3, blank=True, null=True)
    research_type = models.CharField(max_length=1, blank=True, null=True)
    journal_ind = models.CharField(max_length=1, blank=True, null=True)
    ...
    international_act_ind = models.CharField(max_length=1, blank=True, null=True)
    proj_type = models.CharField(max_length=3, blank=True, null=True)
    advance_allowed_ind = models.CharField(max_length=1, blank=True, null=True)
    authority_approval = models.CharField(max_length=1, blank=True, null=True)
    authority = models.CharField(max_length=1, blank=True, null=True)
    ...
    master_agreement_ind = models.CharField(max_length=1, blank=True, null=True)
    progrm_responsibility_type = models.CharField(max_length=30, blank=True, null=True)
    wppp_status = models.CharField(max_length=40, blank=True, null=True)
    wppp_status_date = models.DateField(blank=True, null=True)
    cooperator_agreement_number = models.CharField(max_length=34, blank=True, null=True)
    gid = models.CharField(max_length=16, blank=True, null=True)
