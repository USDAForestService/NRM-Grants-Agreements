# Generated by Django 3.1.7 on 2021-03-10 17:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hhs_payment_ind', models.CharField(choices=[('Y', 'Yes'), ('N', 'No')], max_length=1, verbose_name='HHS payment')),
                ('proposed_start_date', models.DateField()),
                ('proposed_end_date', models.DateField()),
                ('locked_ind', models.CharField(choices=[('Y', 'Yes'), ('N', 'No')], max_length=1, verbose_name='Locked')),
                ('status', models.CharField(choices=[('AGREEMENT-ACTION', 'Agreement action'), ('NEW-APPLICATION', 'New application'), ('APP-ACCEPTED', 'App accepted'), ('APP-APPROVED', 'App approved'), ('APP-PGM REJECTED', 'App PGM rejected'), ('APP-RECEIVED', 'App received'), ('APP-REJECTED', 'App rejected'), ('GA-CANCELLED', 'GA closed'), ('GA-EXECUTED', 'GA executed'), ('GA-PENDING', 'GA pending'), ('GA-TERMINATED', 'GA terminated')], max_length=40)),
                ...
                ('proj_desc', models.TextField(blank=True, max_length=2000, null=True, verbose_name='Project description')),
                ...
                ('proj_science_cd', models.CharField(blank=True, max_length=3, null=True, verbose_name='Project Science CD')),
                ...
                ('extramural_ind', models.CharField(choices=[('Y', 'Yes'), ('N', 'No')], max_length=1, verbose_name='Extramural')),
                ('research_type', models.CharField(blank=True, max_length=1, null=True)),
                ('journal_ind', models.CharField(blank=True, max_length=1, null=True, verbose_name='Journal')),
                ...
                ('aop_ind', models.CharField(choices=[('Y', 'Yes'), ('N', 'No')], max_length=1, verbose_name='AOP')),
                ...
                ('certificaion_date', models.DateField(blank=True, null=True, verbose_name='Certification date')),
                ('ffis_doc_id', models.CharField(blank=True, max_length=11, null=True, verbose_name='FFIS Doc')),
                ('applicant_name', models.CharField(blank=True, max_length=200, null=True)),
                ('international_act_ind', models.CharField(choices=[('Y', 'Yes'), ('N', 'No')], max_length=1, verbose_name='International Act')),
                ('proj_type', models.CharField(blank=True, max_length=3, null=True)),
                ('advance_allowed_ind', models.CharField(choices=[('Y', 'Yes'), ('N', 'No')], max_length=1, verbose_name='Advance Allowed')),
                ...
                ('progrm_responsibility_type', models.CharField(blank=True, max_length=30, null=True, verbose_name='Program Responsibility Type')),
                ...
                ('gid', models.CharField(blank=True, editable=False, max_length=16, null=True)),
        ...
        migrations.CreateModel(
            name='GrantAuthority',
            fields=[
                ('grant_cn', models.CharField(max_length=34, primary_key=True, serialize=False)),
                ('authority_cd', models.CharField(max_length=40)),
                ('authority_desc', models.CharField(blank=True, max_length=120, null=True, verbose_name='Authority Description')),
                ('last_update', models.DateField()),
            ],
            options={
